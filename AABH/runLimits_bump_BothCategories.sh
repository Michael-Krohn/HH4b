...
do
	combineCards.py SR1=outputs/datacards/HH_mX_$i\_HH_LL_Data_13TeV.txt SR2=outputs/datacards/HH_mX_$i\_HH_TT_Data_13TeV.txt AT1=outputs/datacards/HH_mX_$i\_HH_LL_Data_13TeV_fail.txt AT2=outputs/datacards/HH_mX_$i\_HH_TT_Data_13TeV_fail.txt > outputs/datacards/HH_mX_$i\_bump_13TeV.txt
	echo "mass point $i"
