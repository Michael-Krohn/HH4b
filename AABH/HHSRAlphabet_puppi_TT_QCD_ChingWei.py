...
preselection    =       "&jet1pt>300&abs(jet1eta-jet2eta)<1.3&jet1_puppi_tau21<0.55&jet2_puppi_tau21<0.55&dijetmass_softdrop_corr>750&abs(jet1eta)<2.4&abs(jet2eta)<2.4"
...
plotforplotting.GetYaxis().SetRangeUser(0.03,0.12)
...
THILABL.DrawLatex(0.61,0.54,"#chi^{2}/n = %.3f"%(ComputedChiSquared2))
...
CMSLABL.DrawLatex(0.16,0.91,"Preliminary")

LUMILABL = TLatex()
LUMILABL.SetNDC()
LUMILABL.SetTextSize(0.04)
LUMILABL.DrawLatex(0.66,0.91,"36.8 fb^{-1} (13TeV)")
