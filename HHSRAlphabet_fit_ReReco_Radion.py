...
#	if Options.LL_DoubleB_Region:
#	  INJ = DIST("INJ", sigpath+"Radion"+Options.inject+".root","mynewTree",str(Options.lumi)+"*0.01*puWeights*SFLoose/"+str(normI))
#	else:
...
#if Options.LL_DoubleB_Region:
#  quickplot(sigpath+"Radion1200.root", "mynewTree", SIG0, variable2, TightT2, "puWeights*SFLoose/1.")
#  quickplot(sigpath+"Radion1600.root", "mynewTree", SIG1, variable2, TightT2, "puWeights*SFLoose/1.")
#  quickplot(sigpath+"Radion2500.root", "mynewTree", SIG2, variable2, TightT2, "puWeights*SFLoose/1.")
#else:
#  quickplot(sigpath+"Radion1200.root", "mynewTree", SIG0, variable2, TightT2, "puWeights*SFTight/1.")
#  quickplot(sigpath+"Radion1600.root", "mynewTree", SIG1, variable2, TightT2, "puWeights*SFTight/1.")
#  quickplot(sigpath+"Radion2500.root", "mynewTree", SIG2, variable2, TightT2, "puWeights*SFTight/1.")
...
#                quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX_trig_down, variable2, TightT2, "trigWeightDown*puWeights*dbtSF/1.")
                ...
                quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX_FJER_Up, variable2, TightT2, "puWeights*dbtSF*jet1JERup*jet2JERup/1.")
                quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX_FJER_Down, variable2, TightT2, "puWeights*dbtSF*jet1JERdown*jet2JERdown/1.")
...
#		norm = GetNom(sigpath+"Radion%s.root"%(m))
		...
		Signal_mX.Scale(SF_tau21*Options.lumi*0.01/50000.)
		Signal_mX_antitag.Scale(SF_tau21*Options.lumi*0.01/50000.)
		Signal_mX_btag_up.Scale(SF_tau21*Options.lumi*0.01/50000.)
		Signal_mX_btag_down.Scale(SF_tau21*Options.lumi*0.01/50000.)
		Signal_mX_trig_up.Scale(SF_tau21*0.01*Options.lumi/50000.)
		Signal_mX_trig_down.Scale(SF_tau21*0.01*Options.lumi/50000.)
		Signal_mX_pu_up.Scale(Options.lumi*SF_tau21*0.01/50000.)
		Signal_mX_pu_down.Scale(Options.lumi*SF_tau21*0.01/50000.)
		...
		text_file.write("CMS_eff_tau21_sf lnN                    1.0577       -\n") #(0.028/0.979)
...
#			text_file.write("CMS_stat"+Options.name+"_13TeV_bin%s shapeN2                           -       1.000\n"%(bin))
	        ...
	        text_filea.write("lumi_13TeV lnN                          1.026       -\n")
                ...
                text_filea.write("CMS_eff_tau21_sf lnN                    1.0577        -\n") #(0.028/0.979)
