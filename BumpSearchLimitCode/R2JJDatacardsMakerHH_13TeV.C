...
void R2JJDatacardsMakerHH_13TeV(double mass, std::string postfix="", bool dobands=false, int graviton = 0, double nEvents = 50000.)
{
	...
	MakeDataCard_1Channel(w, fileBaseName, fileBkgName, 0, signalname, 0, cat_names, mass);
	MakeDataCard_1Channel(w, fileBaseName, fileBkgName, 1, signalname, 0, cat_names, mass);
	MakeDataCard_1Channel(w, fileBaseName, fileBkgName, 2, signalname, 0, cat_names, mass);
